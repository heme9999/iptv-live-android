...
final class TextListAdapter extends RecyclerView.Adapter<TextListAdapter.Holder> {
    ...
    TextListAdapter(List<String> items, OnTextClick onClick) {
        this.items = items;
    ...
    @Override public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            onClick.accept(items.get(selected));
        });
    }
    ...
    static final class Holder extends RecyclerView.ViewHolder {
        final TextView text;
        Holder(View view) { super(view); text = view.findViewById(R.id.channel_name); }
    }
}
